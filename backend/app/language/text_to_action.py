...
from backend.app.language.ner_manager import load_ner_models, predict_entities
from backend.app.language.classifier_manager import load_classifier_model, predict_classes
from backend.app.apis.router import CommandRouter
...
class TextToAction:
    ...
    def process_text(self, text: str) -> None:
        label, confidence = predict_classes(
            text, self.classifier_model, self.classifier_tokenizer)
